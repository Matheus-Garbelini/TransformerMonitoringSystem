...
const char monthStr1[] PROGMEM = "Janeiro";
const char monthStr2[] PROGMEM = "Fevereiro";
const char monthStr3[] PROGMEM = "Março";
const char monthStr4[] PROGMEM = "Abril";
const char monthStr5[] PROGMEM = "Maio";
const char monthStr6[] PROGMEM = "Junho";
const char monthStr7[] PROGMEM = "Julho";
const char monthStr8[] PROGMEM = "Agosto";
const char monthStr9[] PROGMEM = "Setembro";
const char monthStr10[] PROGMEM = "Outubro";
const char monthStr11[] PROGMEM = "Novembro";
const char monthStr12[] PROGMEM = "Dezembro";
